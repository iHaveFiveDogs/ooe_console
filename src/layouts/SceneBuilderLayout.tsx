        ...
        <div className="main-area">
            <Sidebar>
                <nav style={{ width: '100%' }}>
                    ...
                    <NavItem to='/scene/scene' label='Scenes' icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="2" stroke="#0f172a" strokeWidth="1.2" /></svg>} />
                    <NavItem to='/scene/conflict' label='Conflicts' icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 12h18" stroke="#0f172a" strokeWidth="1.2" strokeLinecap="round" /></svg>} />
                    ...
                    <NavItem to='/scene/topic' label='Topics' icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="8" r="3" stroke="#0f172a" strokeWidth="1.2" /><path d="M4 20c2-4 6-6 8-6s6 2 8 6" stroke="#0f172a" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" /></svg>} />
                </nav>
            </Sidebar>
